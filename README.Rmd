...
`cattonum` (cat to num) is a brand new, under-construction package designed to provide a uniform API for various encodings of categorical features.  It turns categorical features into numeric features.  The following are hoped to eventually be included in the package:
...
The following are other resources to consult for information about categorical encodings:
